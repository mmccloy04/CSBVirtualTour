<!--VARIATION OF LOCATIONS/G3.PHP AND VIDEOS/G3_VIDEO.PHP - SHOWING HOW VIDEO CAN INSTEAD BE EMBEDDED WITHIN THE PAGE -->
...
$location_code = "g3"; //hardcoded as page was renamed when taken out of main tour
...
<html lang="en">
  ...
  <body>
    ...
    <a-scene vr-mode-ui-if-headset>
      ...
      <a-sphere id="m1" radius="1" 
        src="<?php echo "$m1_link_asset" ?>" 
        position="<?php echo "$m1_link_position" ?>"  
        rotation="<?php echo "$m1_link_rotation" ?>" 
        event-set__enter="_event: mouseenter; scale: 1.2 1.2 1.2"
        event-set__leave="_event: mouseleave; scale: 1 1 1">
        <a-text font="kelsonsans" align="center" look-at="#myCamera" width="7" 
        value="<?php echo "$m1_link_text" ?>" position="0 -1.4 0" ></a-text>
      </a-sphere>
  ...
  <script>  
    ...
    document
      .querySelector("#m1")
      .addEventListener("click", e => {
        //location.href = "m1.php";   //link to main tour disabled as this is just a testing page 
    }); 
    ...
    document
      ...
      .addEventListener("click", e => {
        ...
        document.querySelector('#g6').setAttribute('visible', 'false')
        document.querySelector('#lift').setAttribute('visible', 'false')
        document.querySelector('#m1').setAttribute('visible', 'false')
    ...
    function videoEnded() {
        ...
        document.querySelector('#g6').setAttribute('visible', 'true')
        document.querySelector('#lift').setAttribute('visible', 'true')
        document.querySelector('#m1').setAttribute('visible', 'true')
