...
THIS IS COMPARED WHEN THE ASSETS ARE LOADED FROM DATABASE (G5_PRELOADINGASSETS_DATABASE.PHP) VS WHERE THERE IS NO DATABASE (THIS PAGE)-->
  ...
  <body>
    ...
    <a-scene vr-mode-ui-if-headset>
      ...
      <a-assets>
        ...
        <img id="g1_image" crossorigin="anonymous" src="https://mmccloy04.webhosting5.eeecs.qub.ac.uk/assets/locations/g1.jpg">
        <img id="g3_image" crossorigin="anonymous" src="https://mmccloy04.webhosting5.eeecs.qub.ac.uk/assets/locations/g3.jpg">
        <img id="g5_image" crossorigin="anonymous" src="https://mmccloy04.webhosting5.eeecs.qub.ac.uk/assets/locations/g5.jpg">
        <img id="g6_image" crossorigin="anonymous" src="https://mmccloy04.webhosting5.eeecs.qub.ac.uk/assets/locations/g6.jpg">
        <img id="lift_image" crossorigin="anonymous" src="https://mmccloy04.webhosting5.eeecs.qub.ac.uk/assets/locations/lift.jpg">
