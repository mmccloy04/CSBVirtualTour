<!--THIS PAGE IS THE SAME AS S4.PHP EXCEPT THE USER IS NOT RE-DIRECTED TO S4_PHYSICSVR IF IN VR MODE. THIS PAGE HAS BEEN CREATED 
TO TEST/SHOW SHOW S4.PHP CAN STILL BE USED IN VR MODE (THE BOXES ARE JUST AUTOMATICALLY ROTATED WITH THE USER GRABS THEM WITH THEIR HAND-->
...
<html lang="en">
  ...
  <body>
    ...
    <a-scene vr-mode-ui-if-headset> 
     ...
     <a-entity id="interactive_scenario" position="0.1 0.1 -0.4" rotation="0 1 0" visible="false"> 
  ...
  <script> 
    ...
    document.querySelector('a-scene').addEventListener('enter-vr', function () {
      ...
      document.querySelector('#taskText').setAttribute('value',  task_text + '\n(Hint: You can click on the boxes using your controller or by grabbing them with your right hand).');
      ...
      document.querySelector('#interactive_scenario').setAttribute('visible', 'false'); 
    ...
    //TASK BOX - SHOW INTERACTIVE SCENARIO WHEN CLICK ON TASK BOX 
    document
      .querySelector("#task")
      .addEventListener("click", e => {
        //SHOW INTERACTIVE SCENARIO (IF PREVIOUS TASKS HAVE BEEN COMPLETED)
        if (localStorage.getItem("tasksCompleted") >= "4") {
        //if in vr mode redirect to s4_physicsvr
        console.log(localStorage.getItem("vrMode"));
      ...
      .querySelector("#box4")
        .addEventListener("click", e => {
          ...
          //Adapted from: https://stackoverflow.com/questions/27765666/passing-variable-through-javascript-from-one-html-page-to-another-page      
            ...
            } else if (localStorage.getItem("tasksCompleted") == "4") {
