...
Adapted - Changed cancel button to be blank */
    ...
    e.exports = function (e, t) {
      ...
      switch (s) {
        ...
        case 8:
          (a = new CustomEvent("a-keyboard-update", {
            ...
            document.dispatchEvent(a);
          break;
        /* COMMENT - ADDs NEW LINE WHEN ENTER BUTTON (CODE 13) IS SELECTED */ 
        case 13:
          (a = new CustomEvent("a-keyboard-update", {
            detail: { code: s, value: "\n" },
          })),
      ...
      /*case 27:
          this.dismissable &&
            ...
            document.dispatchEvent(a));
          break;
        /* COMMENT - ADDS SPACE WHEN SPACEBAR (CODE 32) IS SELECTED */  
        case 32:
          (a = new CustomEvent("a-keyboard-update", {
            detail: { code: s, value: " " },
          })),
