/* JS SCRIPT FOR VIRTUAL KEYBOARD USED IN C2.PHP  
This has been sourced/adapted from https://wandererou.github.io/aframe-keyboard/ and 
https://wandererou.github.io/aframe-keyboard/examples/basic/index.html 
File downloaded from https://github.com/WandererOU/aframe-keyboard/tree/master/dist 
Updated clear button and disabled enter button */
...
!(function (e) {
    ...
    function (e, t) {
      e.exports = function (e, t) {
        let a;
        const d = new Set([
            16, 17, 18, 20, 33, 34, 35, 36, 45, 46, 112, 113, 114, 115, 116, 117,
        ...
        if ("vr" === t)
          (s = parseInt(
            document.querySelector(`#${e.target.id}`).getAttribute("key-code")
          )),
      ...
      e.exports = class {
        ...
        drawButton(e) {
          ...
          r.setAttribute(
            ...
            this.keyTexture && this.keyTexture.length > 0
              ...
              : r.setAttribute("material", "color: #4a4a4a; opacity: 0.9");
        ...
        drawKeyboard() {
          ...
          if (this.keyboardKeys) {
            const e =
                this.keyboardKeys[this.activeMode] || this.keyboardKeys.normal,
              t = document.createElement("a-entity"),
              a = 0.52,
              d = 0.04 * e.length + 0.004 * (e.length - 1) + 0.04;
            t.setAttribute("position", `${a / 2 - 0.02} ${-d / 2 + 0.02} -0.01`),
              t.setAttribute(
                "geometry",
                `primitive: plane; width: ${a}; height: ${d}`
              ),
              this.baseTexture && this.baseTexture.length > 0
                ? t.setAttribute("material", `src: ${this.baseTexture}`)
                : t.setAttribute(
                    "material",
        ...
        parseKeyObjects(e) {
          ...
          switch (t) {
            ...
            case "space":
              return { size: `${0.2 + 0.016} 0.04 0`, value: a, code: "32" };
            case "cancel":
