...
<html lang="en">
  ...
  <body>
    ...
    <a-scene vr-mode-ui-if-headset>
      ...
      <a-sphere id="f2" radius="1" 
        src="<?php echo "$f2_link_asset" ?>" 
        position="<?php echo "$f2_link_position" ?>"  
        rotation="<?php echo "$f2_link_rotation" ?>" 
        ...
        value="<?php echo "$f2_link_text" ?>" position="0 -1.2 0" ></a-text>
      </a-sphere>
      ...
      <a-sphere id="m1" radius="1" 
        ...
        event-set__leave="_event: mouseleave; scale: 1 1 1">
        <a-text font="kelsonsans" align="center" look-at="#myCamera" width="7" 
        value="<?php echo "$m1_link_text" ?>" position="0 -1.2 0" ></a-text>
      </a-sphere>

      <a-sphere id="m2" radius="1" 
        src="<?php echo "$m2_link_asset" ?>" 
        position="<?php echo "$m2_link_position" ?>"  
        rotation="<?php echo "$m2_link_rotation" ?>" 
        event-set__enter="_event: mouseenter; scale: 1.2 1.2 1.2"
        event-set__leave="_event: mouseleave; scale: 1 1 1">
        <a-text font="kelsonsans" align="center" look-at="#myCamera" width="7" 
        value="<?php echo "$m2_link_text" ?>" position="0 -1.2 0" ></a-text>
      </a-sphere>
