...
<html lang="en">
  ...
  <body>
    ...
    <a-scene vr-mode-ui-if-headset>
      ...
      <a-sphere id="o1" radius="1" 
        src="<?php echo "$o1_link_asset" ?>" 
        position="<?php echo "$o1_link_position" ?>"  
        rotation="<?php echo "$o1_link_rotation" ?>" 
        ...
        value="<?php echo "$o1_link_text" ?>" position="0 -1.5 0" ></a-text>
      </a-sphere>
      
      <a-sphere id="o5" radius="1" 
        src="<?php echo "$o5_link_asset" ?>" 
        position="<?php echo "$o5_link_position" ?>"  
        rotation="<?php echo "$o5_link_rotation" ?>" 
        event-set__enter="_event: mouseenter; scale: 1.2 1.2 1.2"
        event-set__leave="_event: mouseleave; scale: 1 1 1">
        <a-text font="kelsonsans" align="center" look-at="#myCamera" width="7" 
        value="<?php echo "$o5_link_text" ?>" position="0 -1.5 0" ></a-text>
      </a-sphere>
