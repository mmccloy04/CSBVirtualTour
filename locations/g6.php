...
<html lang="en">
  ...
  <body>
    ...
    <a-scene vr-mode-ui-if-headset>
      ...
      <a-sphere id="c1" radius="1" 
        src="<?php echo "$c1_link_asset" ?>" 
        position="<?php echo "$c1_link_position" ?>"  
        rotation="<?php echo "$c1_link_rotation" ?>" 
        ...
        value="<?php echo "$c1_link_text" ?>" position="0 -1.4 0" ></a-text>
      </a-sphere>
      
      <a-sphere id="c2" radius="1" 
        src="<?php echo "$c2_link_asset" ?>" 
        position="<?php echo "$c2_link_position" ?>"  
        rotation="<?php echo "$c2_link_rotation" ?>" 
        event-set__enter="_event: mouseenter; scale: 1.2 1.2 1.2"
        event-set__leave="_event: mouseleave; scale: 1 1 1">
        <a-text font="kelsonsans" align="center" look-at="#myCamera" width="7" 
        value="<?php echo "$c2_link_text" ?>" position="0 -1.4 0" ></a-text>
      </a-sphere>
  ...
  <script>  
    ...
    document
      .querySelector("#c1")
      .addEventListener("click", e => {
        location.href = "c1.php";
    });
    document
      .querySelector("#c2")
      .addEventListener("click", e => {
        location.href = "c2.php";
    });
    document
      .querySelector("#g3")
      .addEventListener("click", e => {
