...
<html lang="en">
  ...
  <body>
    ...
    <a-scene vr-mode-ui-if-headset>
      ...
      <a-sphere id="q6" radius="1" 
        src="<?php echo "$q6_link_asset" ?>" 
        position="<?php echo "$q6_link_position" ?>"  
        rotation="<?php echo "$q6_link_rotation" ?>" 
        event-set__enter="_event: mouseenter; scale: 1.2 1.2 1.2"
        event-set__leave="_event: mouseleave; scale: 1 1 1">
        <a-text font="kelsonsans" align="center" look-at="#myCamera" width="7" 
        value="<?php echo "$q6_link_text" ?>" position="0 -1.3 0" ></a-text>
      </a-sphere>
