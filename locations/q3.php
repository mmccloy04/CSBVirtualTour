...
<html lang="en">
  ...
  <body>
    ...
    <a-scene vr-mode-ui-if-headset>
      ...
      <a-sphere id="q4" radius="1" 
        src="<?php echo "$q4_link_asset" ?>" 
        position="<?php echo "$q4_link_position" ?>"  
        rotation="<?php echo "$q4_link_rotation" ?>" 
        event-set__enter="_event: mouseenter; scale: 1.2 1.2 1.2"
        event-set__leave="_event: mouseleave; scale: 1 1 1">
        <a-text font="kelsonsans" align="center" look-at="#myCamera" width="7" 
        value="<?php echo "$q4_link_text" ?>" position="0 -1.5 0" ></a-text>
      </a-sphere>
