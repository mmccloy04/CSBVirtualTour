<!--LINKED TO FROM S4.PHP IF USER IS IN VR MODE, USER PICKS UP AND ROTATES BOXES WITH HAND
USES PHYSICS SYSTEM AND DYNAMIC/STATIC OBJECTS-->

<!--JAVASCRIPT CHECK LOCAL STORAGE VARIABLE FOR TASKS COMPLETED 
...
<html lang="en">
  <head>
    ...
    <script src="https://cdn.jsdelivr.net/gh/c-frame/aframe-physics-system@v4.2.2/dist/aframe-physics-system.min.js"></script>     <!--script from https://github.com/c-frame/aframe-physics-system/blob/master/CannonDriver.md -->
  ...
  <body>
    ...
    <a-scene id="scene" vr-mode-ui-if-headset>
      ...
      <a-entity>
        ...
        <!--differs from other pages in that it has static body defined in below entity-->
        <a-entity 
          static-body="shape: sphere; sphereRadius: 0.02;" 
          sphere-collider="objects: a-plane, a-box, a-sphere" 
      ...
      <a-box id="task"
        ...
        <a-text id="taskText" value="<?php echo "$task_info_text" ?>" position="0.05 2.3 -0.5" 
        align="center" color="#FFFFFF" width="7" font="kelsonsans" visible="false" look-at="#myCamera"
        geometry="primitive: plane; height: 0; width: 0" material="color: #333333"></a-text>
      </a-box>
      
      <!-- INTERACTIVE SCENARIO, alt position 0 0.5 0-->      
      <a-entity id="interactive_scenario" position="0.1 0.1 -0.4" rotation="0 1 0">  
  ...
  <script> 
    ...
    document.querySelector('a-scene').addEventListener('enter-vr', function () {
      ...
      document.querySelector('#interactive_scenario').setAttribute('position', '0.4 0.5 -0.1'); 
    });
    ...
    document.querySelector('a-scene').addEventListener('exit-vr', function () {
      ...
      //dont change position of table when enter/exit VR Mode in s4_physicsvr as the boxes will move and may fall due to being dynamic bodies
    });
    ...
    //TASK BOX - RELOAD PAGE WHEN CLICK TASK BOX (e.g. if drop boxes off the table) 
    document
      .querySelector("#task")
    ...
    //MARK AS COMPLETE WHEN ROTATE FINAL BOX 
    document
      .querySelector("#box4")
        .addEventListener("click", e => {
