...
<html lang="en">
  ...
  <script> 
    ...
    document.querySelector('a-scene').addEventListener('enter-vr', function () {
      ...
      document.querySelector('#two').setAttribute('position', '-6.1 -0.2 -1.5');
      document.querySelector('#one').setAttribute('position', '-6.1 -1.3 -1.5');
      document.querySelector('#ground').setAttribute('position', '-6.1 -2.4 -1.5');
    });
    ...
    document.querySelector('a-scene').addEventListener('exit-vr', function () {
      ...
      document.querySelector('#two').setAttribute('position', '-4.1 -0.2 -1.5');
      document.querySelector('#one').setAttribute('position', '-4.1 -1.3 -1.5');
      document.querySelector('#ground').setAttribute('position', '-4.1 -2.4 -1.5');
    });
