...
<html lang="en">
  <head>
    ...
    Sourced/adapted from https://jsfiddle.net/s12gjfc4
    and https://stackoverflow.com/questions/68295433/a-frame-trigger-function-when-two-objects-touch -->
    <script>
  ...
  <body>
    ...
    <a-scene vr-mode-ui-if-headset>
      ...
      <a-box id="scanner" class="collidable"  sphere-collider="" height="9" width="1.2" depth="1.2" 
      position="12.1 -4.6 -28"  color="black"></a-box>
      <a-box id="card" 
  ...
  <script> 
    ...
    //CHECK IF USER HAS PREVIOUSLY COMPLETED TASK TO SCAND STUDENT CARD (KEEP SCANNER GREEN AND SPHERE VISIBLE IF SO)
   ...
   //NAVIGATE TO OTHER PAGES (LOCATIONS) 
    ...
    document
      .querySelector("#video")
      .addEventListener("click", e => {
        location.href = "../videos/o1_video.php";
    });
