...
<html lang="en">
  ...
  <body>
    ...
    <a-scene vr-mode-ui-if-headset>
      ...
      <a-sphere id="f1" radius="1" 
        src="<?php echo "$f1_link_asset" ?>" 
        position="<?php echo "$f1_link_position" ?>"  
        rotation="<?php echo "$f1_link_rotation" ?>" 
        ...
        value="<?php echo "$f1_link_text" ?>" position="0 -1.3 0" ></a-text>
      </a-sphere>
      ...
      <a-sphere id="q1" radius="1" 
        ...
        event-set__leave="_event: mouseleave; scale: 1 1 1">
        <a-text font="kelsonsans" align="center" look-at="#myCamera" width="7" 
        value="<?php echo "$q1_link_text" ?>" position="0 -1.4 0" ></a-text>
      </a-sphere>
