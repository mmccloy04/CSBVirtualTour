  ...
  <body>
    ...
    <a-scene vr-mode-ui-if-headset>
      ...
      <a-sky 
        ...
        onloadstart="this.playbackRate = 6;">
      </a-sky> 
      ...
      <a-box id="task" 
        ...
        <a-text id="taskText" value="<?php echo "$task_info_text" ?>" position="0.05 1.6 -0.05" 
  ...
  <script> 
    ...
    document
      ...
      .addEventListener("mouseenter", e => {
        ...
        //Adapted from: https://stackoverflow.com/questions/27765666/passing-variable-through-javascript-from-one-html-page-to-another-page      
          if (localStorage.getItem("tasksCompleted") >= "8") {
          } else if (localStorage.getItem("tasksCompleted") == "7") {
            localStorage.setItem("tasksCompleted","8");
          }
          console.log("Tasks Completed: " + localStorage.getItem("tasksCompleted"));
          
          //SET JS LOCAL STORAGE VARIABLE TO RE-ENABLE LIFT
