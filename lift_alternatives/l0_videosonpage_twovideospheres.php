...
THIS OPTION HAS TWO DIFFERENT VIDEOSPHERES WHICH ARE POPULATED WITH TWO OF THE SIX VIDEOS AT ANY ONE TIME-->
...
if ((sizeof($data) === 0)) {
    ...
    switch ($_SESSION['lift_level']) {
      ...
      case "1":
        ...
        $_POST["video_1_asset"] = $l4_linked_video_firsttoground_asset;
        $_POST["video_1_rotation"] = $l4_linked_video_firsttoground_rotation;
        $_POST["video_2_asset"] = $l4_linked_video_firsttosecond_asset;
        $_POST["video_2_rotation"] = $l4_linked_video_firsttosecond_rotation;
        break;
      case "2":
        ...
        $_POST["video_1_asset"] = $l7_linked_video_secondtoground_asset;
        $_POST["video_1_rotation"] = $l7_linked_video_secondtoground_rotation;
        $_POST["video_2_asset"] = $l7_linked_video_secondtofirst_asset;
        $_POST["video_2_rotation"] = $l7_linked_video_secondtofirst_rotation;
        break;
    }
  }          
?>
...
<script type="text/javascript">
  ...
  var l1_linked_video_groundtosecond_asset = <?php echo json_encode("$l1_linked_video_groundtosecond_asset"); ?>;
  var l1_linked_video_groundtosecond_rotation = <?php echo json_encode("$l1_linked_video_groundtosecond_rotation"); ?>;
  var l1_linked_video_groundtofirst_asset = <?php echo json_encode("$l1_linked_video_groundtofirst_asset"); ?>;
  var l1_linked_video_groundtofirst_rotation = <?php echo json_encode("$l1_linked_video_groundtofirst_rotation"); ?>;
  ...
  var l4_linked_video_firsttoground_asset = <?php echo json_encode("$l4_linked_video_firsttoground_asset"); ?>;
  var l4_linked_video_firsttoground_rotation = <?php echo json_encode("$l4_linked_video_firsttoground_rotation"); ?>;
  var l4_linked_video_firsttosecond_asset = <?php echo json_encode("$l4_linked_video_firsttosecond_asset"); ?>;
  var l4_linked_video_firsttosecond_rotation = <?php echo json_encode("$l4_linked_video_firsttosecond_rotation"); ?>;
  ...
  var l7_linked_video_secondtoground_asset = <?php echo json_encode("$l7_linked_video_secondtoground_asset"); ?>;
  var l7_linked_video_secondtoground_rotation = <?php echo json_encode("$l7_linked_video_secondtoground_rotation"); ?>;
  var l7_linked_video_secondtofirst_asset = <?php echo json_encode("$l7_linked_video_secondtofirst_asset"); ?>;
  var l7_linked_video_secondtofirst_rotation = <?php echo json_encode("$l7_linked_video_secondtofirst_rotation"); ?>;
...
<html lang="en">
  ...
  <script> 
    ...
    //ONCE VIDEO ENDED - update values of videos, sky etc for new floor
    function videoEnded() {
      console.log(lift_level);
      ...
      document.querySelector('#video1').setAttribute('src', l1_linked_video_groundtosecond_asset)
      document.querySelector('#video1').setAttribute('rotation', l1_linked_video_groundtosecond_rotation)
      document.querySelector('#video2').setAttribute('src', l1_linked_video_groundtofirst_asset)
      document.querySelector('#video2').setAttribute('rotation', l1_linked_video_groundtofirst_rotation)
      }
      else if (lift_level == "1") {
      ...
      document.querySelector('#video1').setAttribute('src', l4_linked_video_firsttoground_asset)
      document.querySelector('#video1').setAttribute('rotation', l4_linked_video_firsttoground_rotation)
      document.querySelector('#video2').setAttribute('src', l4_linked_video_firsttosecond_asset)
      document.querySelector('#video2').setAttribute('rotation', l4_linked_video_firsttosecond_rotation)
      }
      else if (lift_level == "2") {
      ...
      document.querySelector('#video1').setAttribute('src', l7_linked_video_secondtoground_asset)
      document.querySelector('#video1').setAttribute('rotation', l7_linked_video_secondtoground_rotation)
      document.querySelector('#video2').setAttribute('src', l7_linked_video_secondtofirst_asset)
      document.querySelector('#video2').setAttribute('rotation', l7_linked_video_secondtofirst_rotation)
      }
