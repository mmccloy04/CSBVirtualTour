<!-- VARIATION OF L0.PHP - THREE SETS OF BUTTONS IMPLEMENTED (ONE FOR EACH FLOOR), HOWEVER DIDNT WORK ONLY APPLYING ANIMATION TO RELEVANT BUTTONS-->
...
<html lang="en">
  ...
  <body>
    ...
    <a-scene vr-mode-ui-if-headset>
      ...
      <!--GROUND FLOOR LIFT BUTTONS-->
      <a-entity id="groundfloor_buttons" visible="false">
        <a-plane id="two" position="-4 -0.2 -1.5" rotation="0 75 0" color="#8C8C8C"
        ...
        <a-plane id="one" position="-4 -1.3 -1.5" rotation="0 75 0" color="#8C8C8C"
            event-set__enter="_event: mouseenter; color: #A6A6A6"
            event-set__leave="_event: mouseleave; color: #8C8C8C">
            <a-text font="kelsonsans" value="1" width="10" position="0 0 0" align="center" color="#FFFFFF"></a-text>
        </a-plane>
        <a-plane id="ground" position="-4 -2.4 -1.5" rotation="0 75 0" color="#A6A6A6">
            <a-text font="kelsonsans" value="G" width="10" position="0 0 0" align="center" color="#FFFFFF"></a-text>
        </a-plane>
      </a-entity>

      <!--FIRST FLOOR LIFT BUTTONS-->
      <a-entity id="firstfloor_buttons" visible="false">
        <a-plane id="two" position="-4 -0.2 -1.5" rotation="0 75 0" color="#8C8C8C"
            event-set__enter="_event: mouseenter; color: #A6A6A6"
            event-set__leave="_event: mouseleave; color: #8C8C8C">
            <a-text font="kelsonsans" value="2" width="10" position="0 0 0" align="center" color="#FFFFFF"></a-text>
        </a-plane>
        <a-plane id="one" position="-4 -1.3 -1.5" rotation="0 75 0" color="#A6A6A6">
            <a-text font="kelsonsans" value="1" width="10" position="0 0 0" align="center" color="#FFFFFF"></a-text>
        </a-plane>
        <a-plane id="ground" position="-4 -2.4 -1.5" rotation="0 75 0" color="#8C8C8C"
            event-set__enter="_event: mouseenter; color: #A6A6A6"
            event-set__leave="_event: mouseleave; color: #8C8C8C">
            <a-text font="kelsonsans" value="G" width="10" position="0 0 0" align="center" color="#FFFFFF"></a-text>
        </a-plane>
      ...
      <!--SECOND FLOOR LIFT BUTTONS-->
      <a-entity id="secondfloor_buttons" visible="false">
        <a-plane id="two" position="-4 -0.2 -1.5" rotation="0 75 0" color="#A6A6A6">
            <a-text font="kelsonsans" value="2" width="10" position="0 0 0" align="center" color="#FFFFFF"></a-text>
        </a-plane>
        <a-plane id="one" position="-4 -1.3 -1.5" rotation="0 75 0" color="#8C8C8C"
            event-set__enter="_event: mouseenter; color: #A6A6A6"
  ...
  <script> 
    ...
    //DISPLAY RELEVANT BUTTONS FOR CURRENT FLOOR
    if (lift_level = "g") {
      document.querySelector('#groundfloor_buttons').setAttribute('visible', 'true')
    } else if (lift_level = "1") {
      document.querySelector('#firstfloor_buttons').setAttribute('visible', 'true')
    } else if (lift_level = "2") {
      document.querySelector('#secondfloor_buttons').setAttribute('visible', 'true')
    };
    ...
    document
      ...
      .addEventListener("click", e => {
        if (lift_level == "g") {
          //location.href = "g5.php"        //link disabled to separate page from main tour
        } else if (lift_level == "1") {
          //location.href = "f3.php"        //link disabled to separate page from main tour
        } else if (lift_level == "2") {
          //location.href = "s3.php"        //link disabled to separate page from main tour
        }
        ;
    });
    ...
    .querySelector("#ground")
      .addEventListener("click", e => {
        ...
        document.querySelector('#groundfloor_buttons').setAttribute('visible', 'true')
        document.querySelector('#firstfloor_buttons').setAttribute('visible', 'false')  
        document.querySelector('#secondfloor_buttons').setAttribute('visible', 'false')    
    ...
    .querySelector("#one")
      .addEventListener("click", e => {
        ...
        document.querySelector('#groundfloor_buttons').setAttribute('visible', 'false')
        document.querySelector('#firstfloor_buttons').setAttribute('visible', 'true')  
        document.querySelector('#secondfloor_buttons').setAttribute('visible', 'false')  
