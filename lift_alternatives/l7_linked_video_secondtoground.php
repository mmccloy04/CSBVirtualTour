...
<html lang="en">
  ...
  <body>
    <a-scene>
      ...
      <a-assets>
        <video id="linked_video" crossorigin="anonymous"
          src="<?php echo "$l7_linked_video_secondtoground_asset" ?>"
          autoplay="true" loop="false" onloadstart="this.playbackRate = 5;" onended="videoEnded()">
        </video>
      </a-assets>
      ...
      <a-videosphere id="videosphere" 
        src="#linked_video"
        rotation="<?php echo "$l7_linked_video_secondtoground_rotation"?>">
      </a-videosphere>
    ...
    <script>     
      function videoEnded() {
          location.href="../lift_alternatives/l1.php";
       }
    </script>
