<!-- L1.PHP, L4.PHP, L7.PHP REPRESENT THE DIFFERENT FLOORS WITHIN THE LIFT AND THE SIX "L1_LINKED_VIDEO..." PAGES
SHOW VIDEOS MOVING BETWEEN THEM. TOGETHER THESE 9 PAGES REPRESENT AN EARLIER VERSION OF THE LIFT -->
...
<html lang="en">
  ...
  <body>
    ...
    <a-scene vr-mode-ui-if-headset>
      ...
      <a-sphere id="g5" radius="1" 
        ...
        value="<?php echo "$g5_link_text" ?>" position="0 -1.4 0" ></a-text>
      </a-sphere>
      ...
      <a-plane id="firstfloor" position="-4.1 -1.3 -1.5" rotation="0 70 0" color="#808080"
          event-set__enter="_event: mouseenter; color: #A6A6A6"
          event-set__leave="_event: mouseleave; color: #808080">
          <a-text font="kelsonsans" value="1" width="10" position="0 0 0" align="center" color="#FFFFFF"></a-text>
      </a-plane>

      <a-plane id="groundfloor" position="-4.1 -2.4 -1.5" rotation="0 70 0" color="#A6A6A6">
  ...
  <script> 
    ...
    document
      ...
      .addEventListener("click", e => {
       location.href = "../lift_alternatives/l1_linked_video_groundtofirst.php";      //link to videos page to play video of lift doors closing/opening
    });

    document
      .querySelector("#secondfloor")
      .addEventListener("click", e => {
       location.href = "../lift_alternatives/l1_linked_video_groundtosecond.php";      //link to videos page to play video of lift doors closing/opening
    });
  </script>
