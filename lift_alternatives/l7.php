...
<html lang="en">
  ...
  <body>
    ...
    <a-scene vr-mode-ui-if-headset>
      ...
      <a-sphere id="s3" radius="1" 
        ...
        value="<?php echo "$s3_link_text" ?>" position="0 -1.4 0" ></a-text>
      </a-sphere>
       
      <!--LIFT BUTTONS (OBJECTS FOR VIDEOS)
      Buttons change colour on hover (except the button for the floor you're currently on) -->
      <a-plane id="secondfloor" position="-4.1 -0.2 -1.5" rotation="0 70 0" color="#A6A6A6">
  ...
  <script> 
    ...
    document
      ...
      .addEventListener("click", e => {
       location.href = "../lift_alternatives/l7_linked_video_secondtofirst.php";      //link to videos page to play video of lift doors closing/opening
    });

    document
      .querySelector("#groundfloor")
      .addEventListener("click", e => {
       location.href = "../lift_alternatives/l7_linked_video_secondtoground.php";     //link to videos page to play video of lift doors closing/opening
    });
