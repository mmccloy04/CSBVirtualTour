...
<html lang="en">
  ...
  <script> 
    ...
    document
      ...
      .addEventListener("click", e => {
       location.href = "../lift_alternatives/l4_linked_video_firsttoground.php";      //link to videos page to play video of lift doors closing/opening
    });

    document
      .querySelector("#secondfloor")
      .addEventListener("click", e => {         
       location.href = "../lift_alternatives/l4_linked_video_firsttosecond.php";     //link to videos page to play video of lift doors closing/opening
    });
  </script>
