...
$location_code = "l1"; //hardcoded as page was renamed when taken out of main tour
...
<html lang="en">
  ...
  <script> 
    ...
    document
      ...
      .addEventListener("click", e => {
       location.href = "lift_l4.php";                  //goes straight to lift on desired floor (no video of transition)
    });
